...
<body>
	<form method="GET" action="${contextPath}/customer/home">
		<input type="submit" class="submit_4" value="Home" />
	</form>
	<!-- search form 3 -->
	<h1>Update Customer By CustomerID</h1>
	<form id="search-form_3">
		<input type="text" class="search_3" /> <input type="submit"
			class="submit_3" value="Update" />
	</form>
</body>
</html>